...
public class DAOKhachHang {
    ...
    public ArrayList<KhachHang> getAllSXTen() {
        String sql = "SELECT * FROM khachhang ORDER BY hoten ASC";
        ArrayList<KhachHang> list = getAllDK(sql);
        return list;
    }

    public ArrayList<KhachHang> getAllSXMa() {
        String sql = "SELECT * FROM khachhang ORDER BY mskh ASC";
        ArrayList<KhachHang> list = getAllDK(sql);
        return list;
    }
    ...
    public ArrayList<KhachHang> checkGetIDKHang(String id){
        String sql=" SELECT * FROM khachhang INNER JOIN hoadon on hoadon.mskh =khachhang.mskh WHERE khachhang.mskh=? AND phanloaiHD=1 ";
        ArrayList<KhachHang> list=getAllDK(sql, String.valueOf(id));
        return list;
